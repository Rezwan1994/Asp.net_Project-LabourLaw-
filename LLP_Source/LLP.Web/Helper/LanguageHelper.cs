...
namespace LLP.Web.Ui.Helper
{
    public class LanguageHelper
    {
        public static string T(string key)
        {
            return new LocalizeFacade().GetResource(key);
        }
        public static string English(string key)
        {
            return new LocalizeFacade().GetResource(key, "en-US");
        }
        public static string Bangla(string key)
        {
            return new LocalizeFacade().GetResource(key, "bn-BGD");
        }
