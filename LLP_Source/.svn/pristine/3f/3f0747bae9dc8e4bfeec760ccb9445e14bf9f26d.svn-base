...
namespace LLP.DataAccess
{
	public partial class EmailTemplateDataAccess : BaseDataAccess
	{
		...
		{	
			AddParameter(cmd, pGuid(EmailTemplateBase.Property_CompanyId, emailTemplateObject.CompanyId));
			...
			AddParameter(cmd, pNVarChar(EmailTemplateBase.Property_Description, 250, emailTemplateObject.Description));
		...
		protected void FillObject(EmailTemplateBase emailTemplateObject, SqlDataReader reader, int start)
		{
				...
				emailTemplateObject.CompanyId = reader.GetGuid( start + 1 );			
				if(!reader.IsDBNull(2)) emailTemplateObject.TemplateKey = reader.GetString( start + 2 );			
				if(!reader.IsDBNull(3)) emailTemplateObject.Name = reader.GetString( start + 3 );			
				if(!reader.IsDBNull(4)) emailTemplateObject.Description = reader.GetString( start + 4 );			
				if(!reader.IsDBNull(5)) emailTemplateObject.ToEmail = reader.GetString( start + 5 );			
				if(!reader.IsDBNull(6)) emailTemplateObject.CcEmail = reader.GetString( start + 6 );			
				if(!reader.IsDBNull(7)) emailTemplateObject.BccEmail = reader.GetString( start + 7 );			
				if(!reader.IsDBNull(8)) emailTemplateObject.FromEmail = reader.GetString( start + 8 );			
				if(!reader.IsDBNull(9)) emailTemplateObject.FromName = reader.GetString( start + 9 );			
				if(!reader.IsDBNull(10)) emailTemplateObject.ReplyEmail = reader.GetString( start + 10 );			
				if(!reader.IsDBNull(11)) emailTemplateObject.Subject = reader.GetString( start + 11 );			
				if(!reader.IsDBNull(12)) emailTemplateObject.BodyContent = reader.GetString( start + 12 );			
				if(!reader.IsDBNull(13)) emailTemplateObject.BodyFile = reader.GetString( start + 13 );			
				if(!reader.IsDBNull(14)) emailTemplateObject.IsActive = reader.GetBoolean( start + 14 );			
				if(!reader.IsDBNull(15)) emailTemplateObject.LastUpdatedBy = reader.GetString( start + 15 );			
				if(!reader.IsDBNull(16)) emailTemplateObject.LastUpdatedDate = reader.GetDateTime( start + 16 );			
			FillBaseObject(emailTemplateObject, reader, (start + 17));
