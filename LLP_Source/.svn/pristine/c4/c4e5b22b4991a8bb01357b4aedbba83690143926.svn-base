...
namespace LLP.Framework
{
    public static class Extentions
    {
        ...
        public static string ToStringDataRow(this DataRow dr, string column)
        {
            return dr[column].ToString();
        }
      

        public static int ToIntDataRow(this DataRow dr, string column)
        {
            return dr[column] != DBNull.Value? Convert.ToInt32(dr[column].ToString()): -1 ;
        }
