...
namespace LLP.Facade
{
    public class ChapterFacade : BaseFacade
    {
        ...
        {
            return _ChapterDataAccess.GetAllChapter(PageNumber, UnitPerPage, SearchText);
        }
        public List<Chapter> GetAllChapterAct(int PageNumber, int UnitPerPage, string SearchText)
        {
            return _ChapterDataAccess.GetAllChapterAct(PageNumber, UnitPerPage, SearchText);
        }
        public Chapter GetChapter(int chapterNO)
        {
            return _ChapterDataAccess.GetChapter(chapterNO);
        }
    }
}
